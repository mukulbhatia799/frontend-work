// _index.tsx (responsive/mobile-first)
// Key improvements:
// - Tightened mobile-first layout, consistent containers, and safe paddings
// - Ensured no overflow on small screens; added max-w and aspect utilities where helpful
// - Fixed asset paths (Next.js public/ => just /images/*)
// - Improved grid collapse behavior and spacing at xs/sm breakpoints
// - Button tap targets ≥44px, accessible labels, and semantic tweaks
// - Copy fixes (typos) and small a11y improvements
...
export default function Index() {
  ...
  return (
    <main className="pt-[var(--header-h,72px)] min-h-screen overflow-x-hidden">
      <Nav />
      ...
      >
        ...
        >
          <div className="relative p-2 sm:p-3 isolate">
            ...
            >
              ...
              >
                <div className="flex items-center gap-3 bg-white rounded-2xl shadow-soft px-3.5 py-2 text-[clamp(0.8rem,2.6vw,1rem)]">
                  <div>
                    <div className="text-slate-400 text-[11px] sm:text-xs">Enter amount</div>
                    <div className="font-semibold">$450.00</div>
                  </div>
                  <div className="rounded-xl bg-emerald-500 text-white font-medium px-3.5 py-1.5 min-h-[40px]">Send</div>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-white rounded-2xl shadow-soft px-4 py-2 text-sm">
        ...
        <div className="order-2 md:order-none md:row-start-2 md:col-start-1 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="mt-6 md:mt-8 flex flex-wrap items-center justify-center md:justify-start gap-3 md:gap-4">
            <a href="#cta" className="btn-primary px-4 py-3 sm:px-5 sm:py-3 text-sm sm:text-base min-h-[44px]">
              Try free trial
            </a>
            <button className="btn-ghost px-4 py-3 sm:px-5 sm:py-3 text-sm sm:text-base min-h-[44px]">View Demo</button>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-10">
        <div className="mx-auto max-w-6xl text-center">
          <h3 className="text-2xl sm:text-3xl font-extrabold">More than 25,000 teams use Collabs</h3>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-slate-500 opacity-60">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-[22px] sm:text-[25px]">Unsplash</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-[22px] sm:text-[25px]">Notion</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold tracking-wide uppercase text-[22px] sm:text-[25px]">INTERCOM</span>
            </div>

            {/* descript (lowercase) */}
            <div className="flex items-center gap-2">
              <span className="grid place-items-center h-10 w-10 border-[5px] border-slate-500 rounded-md text-[30px] font-semibold">d</span>
              <span className="font-semibold lowercase text-[22px] sm:text-[25px]">descript</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-[22px] sm:text-[25px]">grammarly</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="product" className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start bg-gray-50 ring-1 ring-emerald-50/70 p-6 sm:p-8 md:p-12 rounded-2xl">
            {/* LEFT: heading + copy + ratings */}
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold">How we support our partner all over the world</h2>
              ...
              <div className="mt-6 sm:mt-8 flex flex-wrap gap-10 sm:gap-12">
      ...
      {/* FEATURES */}
      <section id="features" className="px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-[1.1fr,1.3fr,auto] gap-6 md:gap-8 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-extrabold">Our Features you can get</h2>
            </div>
            ...
            <div className="md:text-right">
              <button onClick={scrollToId("contact")} className="btn-primary min-h-[44px]">Get Started</button>
            </div>
          </div>
          ...
          <div className="mt-10 grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="rounded-3xl p-6 glass hover:shadow-xl transition h-full">
              <div className="relative h-48 sm:h-52 rounded-2xl overflow-hidden bg-slate-50">
                {/* 2 green panels (left) */}
              ...
              <h3 className="mt-6 text-lg sm:text-xl font-semibold">Collaboration Teams</h3>
            ...
            <div className="rounded-3xl p-6 glass hover:shadow-xl transition h-full">
              ...
              <h3 className="mt-6 text-lg sm:text-xl font-semibold">Cloud Storage</h3>
            ...
            <div className="rounded-3xl p-6 glass hover:shadow-xl transition h-full">
              ...
              <h3 className="mt-6 text-lg sm:text-xl font-semibold">Daily Analytics</h3>
      ...
      {/* BENEFITS */}
      <section id="benefits" className="py-16 bg-gradient-to-r from-emerald-50/60 to-white px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 md:gap-12 items-center">
          {/* LEFT: Title + bullets */}
          <div>
            <h2 className="text-3xl sm:text-4xl font-extrabold">What Benefit Will You Get</h2>
          ...
          <div className="relative isolate w-full max-w-[680px] md:ml-auto mx-auto">
            <div className="rounded-3xl overflow-hidden shadow-xl ring-1 ring-black/5">
              <img src="/images/laptop.png" alt="Laptop" className="block w-full h-[320px] sm:h-[420px] object-cover grayscale contrast-110" />
            </div>
            ...
            >
              <div className="bg-white rounded-2xl shadow-soft px-3.5 py-3 flex items-center gap-3">
            ...
            >
              <div className="bg-white rounded-2xl shadow-soft px-4 sm:px-5 py-3 flex items-center gap-3">
                <span className="grid place-items-center h-7 w-7 rounded-full bg-emerald-100 text-emerald-600">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                    <path d="M20 6L9 17l-5-5" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </span>
                <span className="text-slate-800">Money Transfer Successful</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      {/* PRICING */}
      <section id="pricing" className="px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="mx-auto max-w-6xl">
          {/* header */}
          <div className="text-center max-w-2xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-extrabold">Choose Plan That’s Right For You</h2>
            ...
            <div className="mt-6 inline-flex rounded-2xl bg-white shadow-soft ring-1 ring-slate-100 p-1">
              <button
                ...
                className={`px-4 sm:px-5 py-2 rounded-xl font-medium min-h-[40px] ${
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6 items-stretch">
            {/* FREE */}
            <div className="relative rounded-[28px] bg-white border border-slate-100 shadow-xl hover:shadow-2xl p-6 sm:p-7 flex flex-col min-h-[520px]">
              <div>
                ...
                <div className="mt-6 text-center">
                  <div className="flex flex-col gap-[16px] items-center leading-none">
              ...
              <div className="mt-auto pt-6">
                <button type="button" className="w-full rounded-2xl px-5 py-3 bg-emerald-50 hover:bg-emerald-500 hover:text-white text-emerald-600 font-medium min-h-[48px]">Signup for free</button>
              </div>
            </div>

            {/* PRO */}
            <div className="relative rounded-[28px] overflow-hidden border border-emerald-500 shadow-xl hover:shadow-2xl p-6 sm:p-7 flex flex-col min-h-[560px] bg-emerald-500 text-white">
              <div className="pointer-events-none absolute left-1/2 -translate-x-1/2 top-24 w-[560px] h-[560px] rounded-full bg-emerald-400/55" />
              <div className="pointer-events-none absolute left-1/2 -translate-x-1/2 top-[92px] w-[560px] h-[560px] rounded-full border border-emerald-300/70" />
              ...
              <div className="relative z-[1] mt-auto pt-6">
                <button type="button" className="w-full rounded-2xl px-5 py-3 bg-white text-emerald-600 hover:bg-emerald-900 hover:text-white font-medium min-h-[48px]">Go to pro</button>
              </div>
            </div>
            ...
            <div className="relative rounded-[28px] bg-white border border-slate-100 shadow-xl hover:shadow-2xl p-6 sm:p-7 flex flex-col min-h-[520px]">
              ...
              <div className="mt-auto pt-6">
                <button type="button" className="w-full rounded-2xl px-5 py-3 bg-emerald-50 hover:bg-emerald-500 hover:text-white text-emerald-600 font-medium min-h-[48px]">Go to Business</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="contact" className="scroll-mt-[88px] bg-[#0F172A] text-slate-100">
        <div className="px-4 sm:px-6 lg:px-8 py-16 md:py-20 mx-auto max-w-6xl grid md:grid-cols-2 gap-x-10 md:gap-x-16 gap-y-14">
          {/* LEFT — Top: Testimonial */}
          <div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight">People are Saying<br />About DoWhith</h2>
            <p className="mt-4 text-slate-400 max-w-md">Everything you need to accept to payment and grow your money of manage anywhere on planet</p>
            <div className="mt-6 text-6xl sm:text-7xl leading-none text-white">“</div>

            {/* fixed-height comment box to prevent layout shift */}
            <div className="flex-col max-w-xl relative min-h-[84px] sm:min-h-[70px] overflow-hidden">
            ...
            {/* Avatars + NEXT button */}
            <ul className="mt-6 flex items-center gap-4 overflow-x-auto pb-2 -mx-1 pr-2">
              {people.map((p, i) => {
          ...
          <div className="w-full max-w-md md:ml-auto">
            <div className="rounded-2xl bg-[#1B2330] text-white shadow-soft px-6 sm:px-8 py-8 sm:py-9 ring-1 ring-slate-700">
              ...
              <form className="mt-6 space-y-4">
                <label className="block">
                  ...
                  <input type="email" placeholder="Enter your email" className="mt-2 w-full rounded-lg bg-white text-slate-900 px-4 py-2.5 outline-none" />
                </label>

                <label className="block">
                  <span className="text-sm text-slate-300">Message</span>
                  <textarea rows={3} placeholder="What are you say ?" className="mt-2 w-full rounded-lg bg-white text-slate-900 px-4 py-2.5 outline-none" />
                </label>

                <button type="button" className="w-full rounded-lg bg-emerald-500 hover:bg-emerald-600 transition text-white font-semibold py-3 min-h-[48px]">Request Demo</button>
                <div className="text-end text-slate-400 text-sm">
                  or <a href="#" className="text-white hover:text-white/80 hover:underline">Start Free Trial</a>
                </div>
              </form>
            </div>
          </div>
        ...
        <div className="px-4 sm:px-6 lg:px-8 pb-12">
          <div className="mx-auto max-w-6xl flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-400 text-sm">
